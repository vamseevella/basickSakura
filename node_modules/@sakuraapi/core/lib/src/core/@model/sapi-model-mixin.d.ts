import { Collection, CollectionInsertOneOptions, CollectionOptions, Cursor, Db, DeleteWriteOpResultObject, InsertOneWriteOpResult, ObjectID, ReplaceOneOptions, UpdateWriteOpResult } from 'mongodb';
import { Constructor } from '../helpers/constructor-type';
import { SakuraApi } from '../sakura-api';
import { IDbGetParams, IFromDbOptions } from './';
export declare function SapiModelMixin<C extends Constructor<{}>>(base?: C): {
    new (...args: any[]): {
        _id: ObjectID;
        id: ObjectID;
