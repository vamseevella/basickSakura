    ...
    listen(listenProperties) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function catchBodyParserErrors(err, req, res, next) {
                if (err instanceof SyntaxError && err.status === helpers_1.BAD_REQUEST && 'body' in err) {
                    res.status(helpers_1.BAD_REQUEST).send({
                        body: req.body,
                        error: 'invalid_body'
                    });
                }
            ...
            function handleResponseLocals(req, res, next) {
                ...
                res.locals.data = {};
                res.locals.status = helpers_1.OK;
            ...
            function resLocalsHandler(req, res, next) {
                ...
                res
                    .status(res.locals.status || helpers_1.OK)
